    ...
    return `
      ...
      <head>
        ...
        <style>
          ...
          .meta { display: flex; justify-content: space-around; background: #F1F5F9; padding: 12px; border-radius: 8px; margin-bottom: 22px; }
          .meta div { text-align: center; }
          .meta .num { font-size: 22px; font-weight: bold; color: #0A2540; }
          .meta .lbl { font-size: 12px; color: #64748B; }
          .employee-block { margin-bottom: 24px; page-break-inside: avoid; }
          h3 { color: #0A2540; border-right: 4px solid #F59E0B; padding-right: 10px; margin-bottom: 8px; font-size: 16px; }
          .uname { color: #64748B; font-weight: normal; font-size: 12px; }
          table { width: 100%; border-collapse: collapse; }
          th, td { border: 1px solid #E2E8F0; padding: 8px; text-align: right; font-size: 12px; }
          th { background: #0A2540; color: #fff; font-weight: bold; }
          tr:nth-child(even) { background: #F8FAFC; }
          .footer { text-align: center; margin-top: 24px; padding-top: 10px; border-top: 1px solid #E2E8F0; color: #64748B; font-size: 10px; }
