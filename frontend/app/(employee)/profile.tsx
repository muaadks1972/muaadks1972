      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          <View style={styles.row}>
            <Text style={styles.rowValue}>موظف</Text>
        ...
        <TouchableOpacity testID="signout-button" style={styles.signOutBtn} onPress={onSignOut}>
...
const styles = StyleSheet.create({
  ...
  rowValue: { fontSize: 14, color: colors.textPrimary, fontWeight: "600", maxWidth: "70%", textAlign: "left" },
